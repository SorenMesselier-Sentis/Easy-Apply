...
<body>
    <section class="background">
        ...
        <div class="form">
            <div class="formCard">
                <h2>Inscrivez-vous en tant que candidat</h2>
                <form class="" method="POST" action="{{ route('candidate.store') }}">
                    @csrf {{-- Token check --}}
                    <input type="hidden" name="status_id" value="1">
                    <input type="hidden" name="user_id" value="{{ auth()->user()->id }}">
                    <label for="first_name" class="my-2">Prenom</label>
                    <input class="btn-primary" type="text" placeholder="Votre Prenom" name="first_name"
                    ...
                    <input class="btn-primary" type="text" placeholder="Votre Nom" name="last_name"
